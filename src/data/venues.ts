...
export const ROOMS: Room[] = [
  ...
  },
  {
    ...
    venueId: 'icc',
    level: 'Level 1',
    rect: { x: 250, y: 20, width: 58, height: 11 },
  ...
  },
  {
    ...
    venueId: 'icc',
    level: 'Level 1',
    rect: { x: 122, y: 122, width: 80, height: 14 },
    plan: ['SWING SPACE'],
    aliases: ['Swing Space'],
    description:
      'A band of floor between Halls C, E and F that belongs to whichever of them needs it — the plans colour all three straight through it. Whatever it is joined to for a given year, it is signed as part of that hall rather than under this name.',
    highlights: ['Let to an adjoining hall', 'No entrance of its own', 'Signed as Hall C, E or F'],
  },
  {
    id: 'hall-g',
    name: 'Exhibit Hall G',
  ...
  },
  {
    ...
    plan: ['HALL H'],
    aliases: ['Hall H', 'Exhibit Hall H', 'Family Fun', 'Family Fun Pavilion'],
    description:
      'The middle of the exhibit grid, booths 1400 to 2299 — the largest single stretch of it. The Family Fun Pavilion sits in the bottom right corner of this hall: kids’ and family programming inside the exhibit hall rather than in a room of its own.',
    highlights: ['Booths 1400–2299', 'Family Fun Pavilion (bottom right)', 'Largest exhibit stretch'],
  },
  {
    id: 'hall-i',
    name: 'Exhibit Hall I',
  ...
  },
  {
    ...
    plan: ['HALL J'],
    aliases: ['Hall J', 'Exhibit Hall J'],
    description:
      'Exhibit aisles at the far end of the grid, carrying the low booth numbers — the 100s to the 500s. J and K are stacked one behind the other rather than side by side, so the wall between them runs across the aisles instead of between them, and a stand here is one of the further-along positions on its aisle.',
    highlights: ['Booths 100–599', 'Stacked above Hall K', 'Far end of the grid'],
  },
  {
    id: 'hall-k',
    name: 'Exhibit Hall K',
    ...
    plan: ['HALL K'],
    aliases: ['Hall K', 'Exhibit Hall K'],
    description:
      'The other half of the same aisles as Hall J, on the near side of the wall that cuts across them. The same 100s-to-500s numbering runs through both: a stand here is one of the earlier positions on its aisle.',
    highlights: ['Booths 100–599', 'Shares Hall J’s aisles', 'Near side of the cross wall'],
  },
  ...
  },
  {
    ...
    venueId: 'marriott-downtown',
    level: '1st floor',
    rect: { x: 4, y: 8, width: 10, height: 6 },
    aliases: ['Florida'],
  ...
  },
  {
    ...
    venueId: 'marriott-downtown',
    level: '2nd floor',
    rect: { x: 3, y: 74, width: 10, height: 7 },
    aliases: ['Denver'],
  ...
  },
  {
    ...
    venueId: 'hyatt',
    level: '2nd floor',
    rect: { x: 5, y: 18, width: 7, height: 5 },
    aliases: ['Theory'],
  ...
  },
  {
    ...
    venueId: 'omni',
    level: '2nd floor',
    rect: { x: 66, y: 52, width: 17, height: 33 },
